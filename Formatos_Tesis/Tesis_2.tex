...
\hypersetup{
  ...
  pdfauthor={Salvador Mandujano Rodríguez; Instituto de Ecología A.C.},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Manual para organizar y analizar datos}
\author{Salvador Mandujano Rodríguez \and Instituto de Ecología A.C.}
...
{\centering \includegraphics[width=0.75\linewidth]{figs/f1} 
...
{\centering \includegraphics[width=2.48in]{figs/mapaRAI} 
...
{\centering \includegraphics[width=0.8\linewidth]{Tesis_2_files/figure-latex/corr-1} 
