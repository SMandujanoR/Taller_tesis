...
# Ejemplo de incidiencia (0 y 1) de una especie de mono en 50 fragmentos de selva.
...
# gráfico
par(mfrow = c(1,1))
plot(datos$area, datos$incidencia, pch = 21, bg = "skyblue", col = "black", cex = 1.5, frame.plot = F, main ="Modelo área", xlab =  "Tamaño del fragmento (ha)", ylab = "Probabilidad de incidencia")
...
plot(datos$aislamiento, datos$incidencia, pch = 21, bg = "skyblue", col = "black", cex = 1.5, frame.plot = F, main ="Modelo aislamiento", xlab =  "Distancia entre fragmentos (km)", ylab = "Probabilidad de incidencia")
